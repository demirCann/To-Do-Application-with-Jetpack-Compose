...
import com.demircandemir.todoapp.ui.theme.topAppBarBackgroundColor
import com.demircandemir.todoapp.ui.theme.topAppBarContentColor
...
fun TaskAppBar(
    ...
    if(selectedTask == null) {
        // Log.d("selected", "newbar")
        NewTaskBar(navigateToListScreen = navigateToListScreen)
    } else {
        // Log.d("selected", selectedTask.title)
        ExistingTaskAppBar(
...
fun ExistingTaskAppBarPreview() {
    ExistingTaskAppBar(selectedTask = Task(id = 0, title = "Demircan Demir", description = "Some text", priority = Priority.High), navigateToListScreen = {})
}